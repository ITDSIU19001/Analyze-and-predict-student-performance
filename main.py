...
if tabs == "Dashboard":
    ...
    if len(valid_courses) > 5:
        valid_courses.append("All")  # Add "All" option to the list of valid courses
    ...
    # Filter the data for the selected course or all courses
    if course == "All":
        selected_courses = valid_courses[:-1]  # Exclude "All" from selected courses
    else:
        selected_courses = [course]

    for selected_course in selected_courses:
        course_data = course_data_dict[selected_course]

        # Generate comment and summary statistics
        if len(course_data) > 1:
            if school == "All":
                st.write("Course:", selected_course, " of ", major, " student")
            else:
                st.write("Course:", selected_course, " of ", major + school, " student")
        ...
        with col1:
            ...
            fig.update_layout(
                title="Frequency Range for {}".format(selected_course),
                xaxis_title="Score",
        ...
        with col3:
            ...
            fig.update_layout(
                title="Box plot of Scores for {}".format(selected_course),
                yaxis_title="Score",
                height=400,
                width=400,
            )
        ...
        with col4:
            ...
            selected_TenMH = " " + selected_course
